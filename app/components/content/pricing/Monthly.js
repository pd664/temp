...
function Monthly() {
  return (
    <div className="container">
      <div className="flex justify-between flex-col sm:flex-col md:flex-col lg:flex-row gap-10">
        ...
        <div className="lg:pt-5 sm:lg:pt-5 md:lg:pt-10 lg:pt-10 w-[400px] text-center pb-0">
          ...
          <Card planName={"Basic plan"} price={10} desc={"Ideal for small teams and startups."} num={0} />
        </div>
        ...
        <div className="pt-0 sm:pt-0 md:pt-10 lg:pt-10">
          ...
          <Card planName={"Business plan"} price={20} desc={"Growing teams up to 20 users."} num={1} />
        </div>
        ...
        <div className="lg:pt-5 sm:lg:pt-5 md:lg:pt-10 lg:pt-10 w-[400px] text-center pb-0">
          ...
          <Card planName={"Enterprise plan"} price={40} desc={"Large teams with unlimited users."} num={2} />
        </div>
      </div>
    </div>
  );
