...
function B2Bbuyer() {
  return (
    <div className="container lg:py-[0rem] sm:lg:py-[0rem] md:lg:py-[5rem] lg:py-[5rem]">
      <div className="flex flex-col-reverse sm:flex-col-reverse md:flex-row lg:flex-row items-center gap-5">
          ...
          <div className="">
            ...
            <div className="">
              <p className="text-md text-slate-700 pt-[2rem]">
                Address challenges in customer relationship management with a
                responsive catalog that evolves based on client interactions,
                streamlining the reordering process and improving account
                oversight.
              </p>
            </div>
            <div className="flex flex-col gap-5 py-5">
              <div className="">
                <Card
                  ...
                  title={"Smart Catalog: "}
                  desc={
                    "Offer a dynamic, customizable catalog that adapts to customer preferences and purchase history."
                  }
                />
              </div>
              <div className="">
                <Card
                  ...
                  title={"Easy Reorder:"}
                  desc={
                    "Simplify the reorder process and enhance order and account management ."
                  }
                />
              </div>
              <div className="">
                <Card
                  ...
                  desc={
                    "Provide robust customer support directly through the portal, ensuring issues are resolved quickly and efficiently."
                  }
                />
              </div>
            </div>
