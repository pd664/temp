...
function CommerceCopilots() {
  return (
    <div className="container py-[5rem]">
      <div className="flex flex-col sm:flex-col md:flex-row lg:flex-row gap-5 items-center">
        <div className="flex-1">
          <div className="lex flex-col gap-5">
            <div className="text-[rgb(239,54,24)] flex flex-col gap-5">
              <h1 className="text-4xl sm:text-4xl md:text-6xl lg:text-6xl font-bold whitespace-nowrap">Commerce Copilots</h1>
              {/* <h1 className="text-5xl font-bold"></h1> */}
            </div>
            <div className="py-5">
              <p className="text-md text-slate-700">
                Solve the inefficiencies of manual operations with AI that
                transforms routine tasks like email order processing and
                document management into automated, error-free processes.
              </p>
            </div>
        ...
        height="3rem"
                  ...
                  title={"Emails to Orders: "}
                  desc={
                    "Convert customer emails directly into orders, reducing manual entry."
                  }
                />
              </div>
        ...
        height="3rem"
                  ...
                  desc={
                    "Enhance your sales team's capabilities provides real-time insights."
                  }
                />
              </div>
        ...
        height="3rem"
                  ...
                  desc={
                    "Streamline document handling by automatically extracting and processing data."
                  }
                />
              </div>
        ...
        <div className="flex-1">
          <Image src={"/commerce.png"} alt="Example Image"
                width={1600}
                height={900}
...
export default CommerceCopilots;
